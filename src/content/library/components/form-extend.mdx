...
Where a ready made version exists, it is linked from the example.
...
Also available as the [Meter and Progress](/ui/data-display/meter-progress/) UI
component, with the indeterminate and password strength cases.
...
Also available as the [Range](/ui/forms/range/) UI component.
