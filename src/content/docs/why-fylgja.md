...
Fylgja CSS offers several options to integrate into your projects,
...
- **Fylgja Utilities** package offers a curated selection of CSS utilities
  ...
  Rather than replacing those, Fylgja CSS's utilities are flexible and work seamlessly with Fylgja CSS Tokens, Open Props, or any similar system.

- Fylgja CSS also includes a library of CSS components, which provide ready-to-use,
